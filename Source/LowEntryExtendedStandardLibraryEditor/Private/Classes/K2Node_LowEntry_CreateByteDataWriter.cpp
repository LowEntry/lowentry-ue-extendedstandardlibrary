...
public:
	...
	virtual void Compile(FKismetFunctionContext& Context, UEdGraphNode* Node) override
	{
		...
		UFunction* ConvertFunctionPointer = FindField<UFunction>(ConvertFunctionClass, TEXT("ByteDataWriter_CreateFromEntryArray"));
...
{
	return FText::FromString("Create Byte Data Writer (Callable)");
}
