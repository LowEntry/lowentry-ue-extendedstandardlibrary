...
public:
	...
	*/
	...
	/**
	* Returns a value determined by the given boolean.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Extended Standard Library|Utilities|Conditional", Meta = (DisplayName = "Conditional Float"))
		static float ConditionalFloat(bool Boolean, float TrueValue, float FalseValue);

	/**
	* Returns a value determined by the given boolean.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Extended Standard Library|Utilities|Conditional", Meta = (DisplayName = "Conditional Integer"))
		static int32 ConditionalInteger(bool Boolean, int32 TrueValue, int32 FalseValue);

	/**
	* Returns a value determined by the given boolean.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Extended Standard Library|Utilities|Conditional", Meta = (DisplayName = "Conditional Byte"))
		static uint8 ConditionalByte(bool Boolean, uint8 TrueValue, uint8 FalseValue);

	/**
	* Returns a value determined by the given boolean.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Extended Standard Library|Utilities|Conditional", Meta = (DisplayName = "Conditional Boolean"))
		static bool ConditionalBoolean(bool Boolean, bool TrueValue, bool FalseValue);

	/**
	* Returns a value determined by the given boolean.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Extended Standard Library|Utilities|Conditional", Meta = (DisplayName = "Conditional String"))
		static FString ConditionalString(bool Boolean, const FString& TrueValue, const FString& FalseValue);

	/**
	* Returns a value determined by the given boolean.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Extended Standard Library|Utilities|Conditional", Meta = (DisplayName = "Conditional Name"))
		static FName ConditionalName(bool Boolean, const FName& TrueValue, const FName& FalseValue);

	/**
	* Returns a value determined by the given boolean.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Extended Standard Library|Utilities|Conditional", Meta = (DisplayName = "Conditional Text"))
		static FText ConditionalText(bool Boolean, const FText& TrueValue, const FText& FalseValue);

	/**
	* Returns a value determined by the given boolean.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Extended Standard Library|Utilities|Conditional", Meta = (DisplayName = "Conditional Vector"))
		static FVector ConditionalVector(bool Boolean, const FVector& TrueValue, const FVector& FalseValue);

	/**
	* Returns a value determined by the given boolean.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Extended Standard Library|Utilities|Conditional", Meta = (DisplayName = "Conditional Rotator"))
		static FRotator ConditionalRotator(bool Boolean, const FRotator& TrueValue, const FRotator& FalseValue);

	/**
	* Returns a value determined by the given boolean.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Extended Standard Library|Utilities|Conditional", Meta = (DisplayName = "Conditional Date Time"))
		static FDateTime ConditionalDateTime(bool Boolean, const FDateTime& TrueValue, const FDateTime& FalseValue);

	/**
	* Returns a value determined by the given boolean.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Extended Standard Library|Utilities|Conditional", Meta = (DisplayName = "Conditional Timespan"))
		static FTimespan ConditionalTimespan(bool Boolean, const FTimespan& TrueValue, const FTimespan& FalseValue);

	/**
	* Returns a value determined by the given boolean.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Extended Standard Library|Utilities|Conditional", Meta = (DisplayName = "Conditional Class"))
		static UClass* ConditionalClass(bool Boolean, UClass* TrueValue, UClass* FalseValue);

	/**
	* Returns a value determined by the given boolean.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Extended Standard Library|Utilities|Conditional", Meta = (DisplayName = "Conditional Object"))
		static UObject* ConditionalObject(bool Boolean, UObject* TrueValue, UObject* FalseValue);

	/**
	* Returns a value determined by the given boolean.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Extended Standard Library|Utilities|Conditional", Meta = (DisplayName = "Conditional Actor"))
		static AActor* ConditionalActor(bool Boolean, AActor* TrueValue, AActor* FalseValue);

	/**
	* Returns a value determined by the given boolean.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Extended Standard Library|Utilities|Conditional", Meta = (DisplayName = "Conditional Actor Component"))
		static UActorComponent* ConditionalActorComponent(bool Boolean, UActorComponent* TrueValue, UActorComponent* FalseValue);

	/**
	* Returns a value determined by the given boolean.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Extended Standard Library|Utilities|Conditional", Meta = (DisplayName = "Conditional Pawn"))
		static APawn* ConditionalPawn(bool Boolean, APawn* TrueValue, APawn* FalseValue);

	/**
	* Returns a value determined by the given boolean.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Extended Standard Library|Utilities|Conditional", Meta = (DisplayName = "Conditional Enum"))
		static UEnum* ConditionalEnum(bool Boolean, UEnum* TrueValue, UEnum* FalseValue);

	/**
	* Returns a value determined by the given boolean.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Extended Standard Library|Utilities|Conditional", Meta = (DisplayName = "Conditional Struct"))
		static UStruct* ConditionalStruct(bool Boolean, UStruct* TrueValue, UStruct* FalseValue);

	/**
	* Returns a value determined by the given boolean.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Extended Standard Library|Utilities|Conditional", Meta = (DisplayName = "Conditional Interface"))
		static TScriptInterface<IInterface> ConditionalInterface(bool Boolean, TScriptInterface<IInterface> TrueValue, TScriptInterface<IInterface> FalseValue);
	...
	* Returns a value determined by the given boolean.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Extended Standard Library|Utilities|Conditional", Meta = (DisplayName = "Conditional Float Array"))
		static TArray<float> ConditionalFloatArray(bool Boolean, const TArray<float>& TrueValue, const TArray<float>& FalseValue);

	/**
	* Returns a value determined by the given boolean.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Extended Standard Library|Utilities|Conditional", Meta = (DisplayName = "Conditional Integer Array"))
		static TArray<int32> ConditionalIntegerArray(bool Boolean, const TArray<int32>& TrueValue, const TArray<int32>& FalseValue);

	/**
	* Returns a value determined by the given boolean.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Extended Standard Library|Utilities|Conditional", Meta = (DisplayName = "Conditional Byte Array"))
		static TArray<uint8> ConditionalByteArray(bool Boolean, const TArray<uint8>& TrueValue, const TArray<uint8>& FalseValue);

	/**
	* Returns a value determined by the given boolean.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Extended Standard Library|Utilities|Conditional", Meta = (DisplayName = "Conditional Boolean Array"))
		static TArray<bool> ConditionalBooleanArray(bool Boolean, const TArray<bool>& TrueValue, const TArray<bool>& FalseValue);

	/**
	* Returns a value determined by the given boolean.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Extended Standard Library|Utilities|Conditional", Meta = (DisplayName = "Conditional String Array"))
		static TArray<FString> ConditionalStringArray(bool Boolean, const TArray<FString>& TrueValue, const TArray<FString>& FalseValue);

	/**
	* Returns a value determined by the given boolean.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Extended Standard Library|Utilities|Conditional", Meta = (DisplayName = "Conditional Name Array"))
		static TArray<FName> ConditionalNameArray(bool Boolean, const TArray<FName>& TrueValue, const TArray<FName>& FalseValue);

	/**
	* Returns a value determined by the given boolean.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Extended Standard Library|Utilities|Conditional", Meta = (DisplayName = "Conditional Text Array"))
		static TArray<FText> ConditionalTextArray(bool Boolean, const TArray<FText>& TrueValue, const TArray<FText>& FalseValue);

	/**
	* Returns a value determined by the given boolean.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Extended Standard Library|Utilities|Conditional", Meta = (DisplayName = "Conditional Vector Array"))
		static TArray<FVector> ConditionalVectorArray(bool Boolean, const TArray<FVector>& TrueValue, const TArray<FVector>& FalseValue);

	/**
	* Returns a value determined by the given boolean.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Extended Standard Library|Utilities|Conditional", Meta = (DisplayName = "Conditional Rotator Array"))
		static TArray<FRotator> ConditionalRotatorArray(bool Boolean, const TArray<FRotator>& TrueValue, const TArray<FRotator>& FalseValue);

	/**
	* Returns a value determined by the given boolean.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Extended Standard Library|Utilities|Conditional", Meta = (DisplayName = "Conditional Date Time Array"))
		static TArray<FDateTime> ConditionalDateTimeArray(bool Boolean, const TArray<FDateTime>& TrueValue, const TArray<FDateTime>& FalseValue);

	/**
	* Returns a value determined by the given boolean.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Extended Standard Library|Utilities|Conditional", Meta = (DisplayName = "Conditional Timespan Array"))
		static TArray<FTimespan> ConditionalTimespanArray(bool Boolean, const TArray<FTimespan>& TrueValue, const TArray<FTimespan>& FalseValue);

	/**
	* Returns a value determined by the given boolean.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Extended Standard Library|Utilities|Conditional", Meta = (DisplayName = "Conditional Class Array"))
		static TArray<TSubclassOf<UObject>> ConditionalClassArray(bool Boolean, const TArray<TSubclassOf<UObject>>& TrueValue, const TArray<TSubclassOf<UObject>>& FalseValue);

	/**
	* Returns a value determined by the given boolean.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Extended Standard Library|Utilities|Conditional", Meta = (DisplayName = "Conditional Object Array"))
		static TArray<UObject*> ConditionalObjectArray(bool Boolean, const TArray<UObject*>& TrueValue, const TArray<UObject*>& FalseValue);

	/**
	* Returns a value determined by the given boolean.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Extended Standard Library|Utilities|Conditional", Meta = (DisplayName = "Conditional Actor Array"))
		static TArray<AActor*> ConditionalActorArray(bool Boolean, const TArray<AActor*>& TrueValue, const TArray<AActor*>& FalseValue);

	/**
	* Returns a value determined by the given boolean.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Extended Standard Library|Utilities|Conditional", Meta = (DisplayName = "Conditional Actor Component Array"))
		static TArray<UActorComponent*> ConditionalActorComponentArray(bool Boolean, const TArray<UActorComponent*>& TrueValue, const TArray<UActorComponent*>& FalseValue);

	/**
	* Returns a value determined by the given boolean.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Extended Standard Library|Utilities|Conditional", Meta = (DisplayName = "Conditional Pawn Array"))
		static TArray<APawn*> ConditionalPawnArray(bool Boolean, const TArray<APawn*>& TrueValue, const TArray<APawn*>& FalseValue);

	/**
	* Returns a value determined by the given boolean.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Extended Standard Library|Utilities|Conditional", Meta = (DisplayName = "Conditional Enum Array"))
		static TArray<UEnum*> ConditionalEnumArray(bool Boolean, const TArray<UEnum*>& TrueValue, const TArray<UEnum*>& FalseValue);

	/**
	* Returns a value determined by the given boolean.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Extended Standard Library|Utilities|Conditional", Meta = (DisplayName = "Conditional Struct Array"))
		static TArray<UStruct*> ConditionalStructArray(bool Boolean, const TArray<UStruct*>& TrueValue, const TArray<UStruct*>& FalseValue);
